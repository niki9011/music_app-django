...
urlpatterns = [
    ...
    path('profile/create', profile_create, name="profiles create"),
    path('profile/details', profile_details, name="profiles details"),
    path('profile/edit', profile_edit, name="profiles edit"),
    path('profile/delete', profile_delete, name="profiles delete"),
